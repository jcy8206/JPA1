...
public class OrderServiceTest {
    ...
    public void 주문취소() throws Exception{
        ...
        Assert.assertEquals("주문 취소시 상태는 CANCEL 이다.", OrderStatus.CANCEL, gerOrder.getOrderStatus());
        Assert.assertEquals("주문이 취소된 상품은 그 만큼 재고가 증가해야한다.", 10, item.getStockQuantity());
    }
